            ...
            try
            {
                do
                {
                    ...
                    try
                    {
                        ...
                        {
                            case 1:
                                Console.WriteLine("Create the instance of the Derived class in the switch-case construct of the Main method by using Swap generic method");
                                Swap<Derived>();
                                
                                break;
                            case 2:
                                Console.WriteLine("create Derived_public_field");
